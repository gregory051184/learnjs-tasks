...
let alreadyRead = new WeakSet(); // выберем WeakSet, т.к. требуется сохранить только факт прочтения

alreadyRead.add(messages[0]);
alreadyRead.add(messages[2]);

console.log(alreadyRead.has(messages[2]));
