...
// Одной из них является тестирование. Нам могут понадобиться случайные данные: текст,
// числа и т.д., чтобы хорошо всё проверить.
...
// как первое значение, и затем генерируют следующее, используя формулу.
...
function* pseudoRandom(seed) {
    let previous = seed;
    while (true) {
        let next_seed = previous * 16807 % 2147483647;
        previous = next_seed;
        yield next_seed;
    }
